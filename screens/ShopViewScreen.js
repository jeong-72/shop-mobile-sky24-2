          ...
          >
            ...
            <View>
              ...
              >
                ...
                >
                  <IconButton icon="pencil" mode="contained" iconColor={theme.colors.onSecondary} size={24} onPress={() => { showEditProduct(product.id) }} />
                </View>
                <View
                  style={{
                    flex: 1,
                ...
                >
                  <IconButton icon="delete"  mode="contained" iconColor={theme.colors.onSecondary} size={24} onPress={() => {showDialog(product.id,product.name) }} />
                </View>
              </View>
            </View>
